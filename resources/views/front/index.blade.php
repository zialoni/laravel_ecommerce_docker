            ...
            <div class="col-md-5 no-padding">                
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    <img src="{{asset('storage/media/left-promo.jpg')}}" alt="img">                    
                       ...
                       @foreach($home_categories_product[$list->id] as $productArr)
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn" href="javascript:void(0)" onclick="home_add_to_cart('{{$productArr->id}}','{{$home_product_attr[$productArr->id][0]->size}}','{{$home_product_attr[$productArr->id][0]->color}}')"></span>Add To Cart</a>
                            <figcaption>
        ...
        <div class="col-md-12">
          <div class="aa-client-brand-area">
            ...
            @foreach($home_brand as $list)
              <li><a href="#"><img src="{{asset('storage/media/brand/'.$list->image)}}" alt="wordPress img"></a></li>
              @endforeach
            </ul>
          </div>
        </div>
