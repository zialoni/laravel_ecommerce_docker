            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>0405-252034</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-logo">
                ...
                <a href="{{url('/')}}">
                  ...
                  <p>ZM<strong>Shop</strong><span>Your Shopping Guru</span></p>
                </a>
                <!-- img based logo -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                      <p> Sunnybank Hills, Brisbane, AU</p>
                      <p><span class="fa fa-phone"></span>+61 405252034</p>
                      <p><span class="fa fa-envelope"></span>ziadikhan8@gmail.com</p>
                    </address>
      ...
      <div class="container">
        ...
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by <a href="https://markhor-media.netlify.app/">Markhormedia.org</a></p>
