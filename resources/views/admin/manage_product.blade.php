...
<div class="form-group">
        ...
        <h1 class="mb-1">Product Attributes</h1>
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              @if($pAArr['attr_image']!='')
                                 <a href="{{asset('storage/media/'.$pAArr['attr_image'])}}" target="_blank"><img width="100px" src="{{asset('storage/media/'.$pAArr['attr_image'])}}"/></a>
                              @endif
                           </div>
                           @if($loop_count_num==2)
                           <div class="col-md-2">
                              <label for="attr_image" class="control-label"> 
                              &nbsp;&nbsp;</label>               
...
<script>
   ...
   function add_more(){
       ...
       html+='<div class="col-md-2"><label for="attr_image" class="control-label mb-1"> &nbsp;&nbsp;&nbsp;</label><button type="button" class="btn btn-danger btn-lg mt-4" onclick=remove_more("'+loop_count+'")><i class="fa fa-minus"></i>&nbsp; Remove</button></div>'; 
